...
<br>
<h4>Coin Payments Public Key:</h4>
<input type="text" name="CP_publickey" value="<?php echo settings('CP_publickey'); ?>" class="form-control">
<br>
<h4>Coinpayments Private Key:</h4>
<input type="text" name="CP_privatekey" value="<?php echo settings('CP_privatekey'); ?>" class="form-control">
<br>
<h4>Coinpayments IPN Secret Key:</h4>
<input type="text" name="CP_secret" value="<?php echo settings('CP_secret'); ?>" class="form-control">
<br>
<h4>Coinpayments Merchant ID:</h4>
<input type="text" name="CP_merchant" value="<?php echo settings('CP_merchant'); ?>" class="form-control">
<br>
<h4>Company Phone:</h4>
...
<br>
<h4>Company Link URL:</h4>
<input type="text" name="Company" value="<?php echo settings('Company'); ?>" class="form-control">
<br>
<h4>Footer Code e.g, Google Analytics/Live Chat code:</h4>
<input type="text" name="Code" value="" class="form-control" placeholder="Please Add all codes once.">
